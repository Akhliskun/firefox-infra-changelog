...
def get_hg_changes(hg_repository_name, push_type):
    """
    ...
    :param hg_repository_name: link of the repository, eg: https://hg.mozilla.org/build/nagios-tools/
    ...
    if push_type == "json-log":
        request_url = hg_repository_name + push_type
...
def write_commits(commit_content, file_name):
    ...
    :param commit_content: usually json formatted content

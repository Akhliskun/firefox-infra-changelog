##  Commits in production - for 3 days, generated on: 2019-04-16 10:56:58 UTC.
|	autoland	|	[MarkDown](https://github.com/mozilla-releng/firefox-infra-changelog/blob/master/hg_files/autoland.md)	|	[Json](https://github.com/mozilla-releng/firefox-infra-changelog/blob/master/hg_files/autoland.json)	| 
|:----------:|:-----------------------:|:--------:| 
 
| Link | Last commit | Author | Reviewer | Deploy time | 
|:----------:|:-----------:|:------:|:--------:|:-----------:| 
|[Link](https://hg.mozilla.org/integration/autoland/pushloghtml?changeset=9463e541aa94)|[Bug 1538278](https://bugzilla.mozilla.org/show_bug.cgi?id=1538278)  - Adds route for accessing geckoview releases r=tomprince,jlorenzo Differential Revision: https://phabricator.services.mozilla.com/D23928|mhentges@mozilla.com|tomprince,jlorenzo|2019-04-16 12:47:30|
...
| Link | Last commit | Author | Reviewer | Deploy time | 
|:----------:|:-----------:|:------:|:--------:|:-----------:| 
|[Link](https://hg.mozilla.org/integration/mozilla-inbound/pushloghtml?changeset=c6c39f570b1f)|[Bug 1541527](https://bugzilla.mozilla.org/show_bug.cgi?id=1541527)  - [ci] Remove unused raptor chrome group symbols, r=rwood Differential Revision: https://phabricator.services.mozilla.com/D27504|ccoroiu@mozilla.com|rwood|2019-04-16 07:10:43|
|[Link](https://hg.mozilla.org/integration/mozilla-inbound/pushloghtml?changeset=99e40003ff9a)|[Bug 1541527](https://bugzilla.mozilla.org/show_bug.cgi?id=1541527)  - Remove "-e10s" from treeherder group symbols and task labels, r=jmaher,gbrown Since e10s is the default configuration, we shouldn't explicitly mark things with the "-e10s" suffix. Instead we should mark things that *don't* run with 'e10s. This patch removes '-e10s' from all treeherder group symbols and task labels, adds the "-1proc" suffix to tasks that are non-e10s. Differential Revision: https://phabricator.services.mozilla.com/D25958|ccoroiu@mozilla.com|jmaher,gbrown|2019-04-16 07:10:43|
|[Link](https://hg.mozilla.org/integration/mozilla-inbound/pushloghtml?changeset=4574b686fdd4)|[Bug 1544441](https://bugzilla.mozilla.org/show_bug.cgi?id=1544441)  - prevent selecting windows10-aarch64 jobs using old try syntax and fuzzy unless --full is used r=jmaher Changes: - added windows10-aarch64 to the filter for fuzzy, to require `--full` in order to trigger jobs - return False for any test tasks that contain windows10-aarch64 to prevent users using old try syntax from overwhelming the limited number of hardware Differential Revision: https://phabricator.services.mozilla.com/D27590|ccoroiu@mozilla.com|jmaher|2019-04-16 07:10:43|
...
| Link | Last commit | Author | Reviewer | Deploy time | 
|:----------:|:-----------:|:------:|:--------:|:-----------:| 
|[Link](https://hg.mozilla.org/mozilla-central/pushloghtml?changeset=c6c39f570b1f)|[Bug 1541527](https://bugzilla.mozilla.org/show_bug.cgi?id=1541527)  - [ci] Remove unused raptor chrome group symbols, r=rwood Differential Revision: https://phabricator.services.mozilla.com/D27504|ccoroiu@mozilla.com|rwood|2019-04-16 07:04:58|
|[Link](https://hg.mozilla.org/mozilla-central/pushloghtml?changeset=99e40003ff9a)|[Bug 1541527](https://bugzilla.mozilla.org/show_bug.cgi?id=1541527)  - Remove "-e10s" from treeherder group symbols and task labels, r=jmaher,gbrown Since e10s is the default configuration, we shouldn't explicitly mark things with the "-e10s" suffix. Instead we should mark things that *don't* run with 'e10s. This patch removes '-e10s' from all treeherder group symbols and task labels, adds the "-1proc" suffix to tasks that are non-e10s. Differential Revision: https://phabricator.services.mozilla.com/D25958|ccoroiu@mozilla.com|jmaher,gbrown|2019-04-16 07:04:58|
|[Link](https://hg.mozilla.org/mozilla-central/pushloghtml?changeset=4574b686fdd4)|[Bug 1544441](https://bugzilla.mozilla.org/show_bug.cgi?id=1544441)  - prevent selecting windows10-aarch64 jobs using old try syntax and fuzzy unless --full is used r=jmaher Changes: - added windows10-aarch64 to the filter for fuzzy, to require `--full` in order to trigger jobs - return False for any test tasks that contain windows10-aarch64 to prevent users using old try syntax from overwhelming the limited number of hardware Differential Revision: https://phabricator.services.mozilla.com/D27590|ccoroiu@mozilla.com|jmaher|2019-04-16 07:04:58|
